...
$('#contactform').validate({
        ...
        messages: {
            ...
            company: '<span class="icon-false" style=""></span>',
            contact_email: {
...
if ($("#contactform").valid()) {
  ...
  var dataString = 'contactname='+ contactname + 'company='+ company + '&contactemail='+ contactemail+ '&contactphone='+ contactphone+ '&contactmessage='+ contactmessage+ '&contactrefer='+ contactrefer;
  $.ajax({
    type: "POST",
