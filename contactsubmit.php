...
//Insert query
$query = mysql_query("insert into contacts(name, company, email,phone,message,referer,date) values ('$contactname', '$contactemail', '$contactphone', '$contactmessage', '$contactrefer',now())");
